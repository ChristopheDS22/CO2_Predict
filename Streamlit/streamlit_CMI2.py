...
if page == pages[2]:
    ...
    with tab2:
       ...
       #on définit des couleurs identiques poru les variables semblables
        ...
        st.dataframe(df_2013_nettoye.head())
    ...
    with tab3:
        ...
        with commentaires:
            ...
            sns.heatmap(df_2013_nettoye.corr(), annot = True, ax = ax, cmap = 'magma');
            st.pyplot(fig)
        
        #with graphe:
         #   fig, ax = plt.subplots(figsize = (2, 2))
         #   var2=df_2013_nettoye.drop(['Cat_CO2','Marque','Carburant','Carrosserie','boite','gamme2'],axis=1)
         #   st.write(var2.head())
